    ...
    return (
        <Cookie.View>
            ...
            <Cookie.Text>
                ...
                bereitgestellt haben oder die im Rahmen der Nutzung der Dienste
                gesammelt wurden. Wenn Sie der Verwendung nicht zustimmen,
                benutzen wir ausschließlich Cookies, die für die Funktionalität
                der Webseite essentiell sind. Weitere Informationen finden Sie
                unter <a href="impressum">Impressum</a> und{" "}
                <a href="datenschutz">Datenschutz</a>.
            </Cookie.Text>
            <Cookie.ActionContainer>
                <Cookie.Action>Cookies ablehnen</Cookie.Action>
                <Cookie.Action type="accept">Cookies akzeptieren</Cookie.Action>
            </Cookie.ActionContainer>
        </Cookie.View>
    );
};
